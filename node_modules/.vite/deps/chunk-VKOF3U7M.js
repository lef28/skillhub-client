...
function polymap(domain, range, interpolate2) {
  var j3 = Math.min(domain.length, range.length) - 1, d3 = new Array(j3), r4 = new Array(j3), i3 = -1;
...
function formatGroup_default(grouping, thousands) {
  return function(value, width) {
    var i3 = value.length, t7 = [], j3 = 0, g3 = grouping[0], length = 0;
    while (i3 > 0 && g3 > 0) {
...
function loggish(transform) {
  ...
  scale.ticks = function(count2) {
    ...
    if (r4 = v4 < u3)
      i3 = u3, u3 = v4, v4 = i3;
    var i3 = logs(u3), j3 = logs(v4), p3, k4, t7, n3 = count2 == null ? 10 : +count2, z2 = [];
    if (!(base % 1) && j3 - i3 < n3) {
      ...
      z2 = ticks_default(i3, j3, Math.min(j3 - i3, n3)).map(pows);
    }
...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date2) {
      var string = [], i3 = -1, j3 = 0, n3 = specifier.length, c8, pad2, format2;
...
function number2(t7) {
  return t7 instanceof Date ? +t7 : +new Date(+t7);
}
...
Bundle.prototype = {
  ...
  lineEnd: function() {
    ...
    if (j3 > 0) {
      var x0 = x5[0], y0 = y4[0], dx = x5[j3] - x0, dy = y4[j3] - y0, i3 = -1, t7;
      while (++i3 <= j3) {
        t7 = i3 / j3;
        this._basis.point(
...
var g = (0, import_react6.memo)(function(t7) {
  ...
  var j3 = useSpring({ to: C4, config: f4, immediate: !p3 || E3 }), O5 = v2({}, x3, l3.tooltip, { transform: null != (o3 = j3.transform) ? o3 : m2(N2, V2) });
...
var B2 = function(i3) {
  var n3, r4, l3, c8, h3, g3, m4, f4, u3, v4, y4, b4 = i3.x, k4 = i3.y, x5 = i3.width, A3 = i3.height, W2 = i3.data, z2 = i3.direction, C4 = void 0 === z2 ? "left-to-right" : z2, B3 = i3.justify, w3 = void 0 !== B3 && B3, X2 = i3.textColor, Y2 = i3.background, H2 = void 0 === Y2 ? "transparent" : Y2, E3 = i3.opacity, j3 = void 0 === E3 ? 1 : E3, T3 = i3.symbolShape, L = void 0 === T3 ? "square" : T3, M2 = i3.symbolSize, F2 = void 0 === M2 ? 16 : M2, P3 = i3.symbolSpacing, R = void 0 === P3 ? 8 : P3, q = i3.symbolBorderWidth, V2 = void 0 === q ? 0 : q, D2 = i3.symbolBorderColor, G = void 0 === D2 ? "transparent" : D2, I = i3.onClick, N2 = i3.onMouseEnter, _ = i3.onMouseLeave, J = i3.toggleSerie, K2 = i3.effects, Q = (0, import_react8.useState)({}), U = Q[0], Z = Q[1], $ = Vt(), tt2 = (0, import_react8.useCallback)(function(t7) {
    if (K2) {
    ...
    null == _ || _(W2, t7);
  }, [_, W2, K2]), it2 = S2({ direction: C4, justify: w3, symbolSize: null != (n3 = U.symbolSize) ? n3 : F2, symbolSpacing: R, width: x5, height: A3 }), nt2 = it2.symbolX, ot2 = it2.symbolY, rt2 = it2.labelX, lt = it2.labelY, at2 = it2.labelAnchor, ct = it2.labelAlignment, st2 = [I, N2, _, J].some(function(t7) {
    return void 0 !== t7;
  }), dt = "function" == typeof L ? L : O4[L];
  return (0, import_jsx_runtime3.jsxs)("g", { transform: "translate(" + b4 + "," + k4 + ")", style: { opacity: null != (r4 = U.itemOpacity) ? r4 : j3 }, children: [(0, import_jsx_runtime3.jsx)("rect", { width: x5, height: A3, fill: null != (l3 = U.itemBackground) ? l3 : H2, style: { cursor: st2 ? "pointer" : "auto" }, onClick: function(t7) {
    null == I || I(W2, t7), null == J || J(W2.id);
  }, onMouseEnter: tt2, onMouseLeave: et2 }), a3.createElement(dt, p2({ id: W2.id, x: nt2, y: ot2, size: null != (c8 = U.symbolSize) ? c8 : F2, fill: null != (h3 = null != (g3 = W2.fill) ? g3 : W2.color) ? h3 : "black", borderWidth: null != (m4 = U.symbolBorderWidth) ? m4 : V2, borderColor: null != (f4 = U.symbolBorderColor) ? f4 : G }, W2.hidden ? $.legends.hidden.symbol : void 0)), (0, import_jsx_runtime3.jsx)("text", { textAnchor: at2, style: p2({}, $.legends.text, { fill: null != (u3 = null != (v4 = null != (y4 = U.itemTextColor) ? y4 : X2) ? v4 : $.legends.text.fill) ? u3 : "black", dominantBaseline: ct, pointerEvents: "none", userSelect: "none" }, W2.hidden ? $.legends.hidden.text : void 0), x: rt2, y: lt, children: W2.label })] });
};
var w2 = function(e6) {
  var i3 = e6.data, n3 = e6.x, o3 = e6.y, r4 = e6.direction, l3 = e6.padding, a4 = void 0 === l3 ? 0 : l3, c8 = e6.justify, s4 = e6.effects, d3 = e6.itemWidth, h3 = e6.itemHeight, g3 = e6.itemDirection, m4 = void 0 === g3 ? "left-to-right" : g3, f4 = e6.itemsSpacing, u3 = void 0 === f4 ? 0 : f4, v4 = e6.itemTextColor, p3 = e6.itemBackground, y4 = void 0 === p3 ? "transparent" : p3, b4 = e6.itemOpacity, x5 = void 0 === b4 ? 1 : b4, S3 = e6.symbolShape, A3 = e6.symbolSize, W2 = e6.symbolSpacing, z2 = e6.symbolBorderWidth, C4 = e6.symbolBorderColor, O5 = e6.onClick, w3 = e6.onMouseEnter, X2 = e6.onMouseLeave, Y2 = e6.toggleSerie, H2 = k3({ itemCount: i3.length, itemWidth: d3, itemHeight: h3, itemsSpacing: u3, direction: r4, padding: a4 }).padding, E3 = "row" === r4 ? d3 + u3 : 0, j3 = "column" === r4 ? h3 + u3 : 0;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n3 + "," + o3 + ")", children: i3.map(function(e7, i4) {
    return (0, import_jsx_runtime3.jsx)(B2, { data: e7, x: i4 * E3 + H2.left, y: i4 * j3 + H2.top, width: d3, height: h3, direction: m4, justify: c8, effects: s4, textColor: v4, background: y4, opacity: x5, symbolShape: S3, symbolSize: A3, symbolSpacing: W2, symbolBorderWidth: z2, symbolBorderColor: C4, onClick: O5, onMouseEnter: w3, onMouseLeave: X2, toggleSerie: Y2 }, i4);
  }) });
};
var X = function(e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r4 = e6.translateX, l3 = void 0 === r4 ? 0 : r4, a4 = e6.translateY, c8 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h3 = e6.padding, g3 = void 0 === h3 ? 0 : h3, m4 = e6.justify, f4 = e6.itemsSpacing, u3 = void 0 === f4 ? 0 : f4, v4 = e6.itemWidth, p3 = e6.itemHeight, y4 = e6.itemDirection, b4 = e6.itemTextColor, S3 = e6.itemBackground, A3 = e6.itemOpacity, W2 = e6.symbolShape, z2 = e6.symbolSize, C4 = e6.symbolSpacing, O5 = e6.symbolBorderWidth, B3 = e6.symbolBorderColor, X2 = e6.onClick, Y2 = e6.onMouseEnter, H2 = e6.onMouseLeave, E3 = e6.toggleSerie, j3 = e6.effects, T3 = k3({ itemCount: i3.length, itemsSpacing: u3, itemWidth: v4, itemHeight: p3, direction: d3, padding: g3 }), L = T3.width, M2 = T3.height, F2 = x4({ anchor: s4, translateX: l3, translateY: c8, containerWidth: n3, containerHeight: o3, width: L, height: M2 }), P3 = F2.x, R = F2.y;
...
var H = function(t7, e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r4 = e6.translateX, l3 = void 0 === r4 ? 0 : r4, a4 = e6.translateY, c8 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h3 = e6.padding, g3 = void 0 === h3 ? 0 : h3, m4 = e6.justify, f4 = void 0 !== m4 && m4, u3 = e6.itemsSpacing, v4 = void 0 === u3 ? 0 : u3, p3 = e6.itemWidth, y4 = e6.itemHeight, b4 = e6.itemDirection, A3 = void 0 === b4 ? "left-to-right" : b4, W2 = e6.itemTextColor, z2 = e6.symbolSize, C4 = void 0 === z2 ? 16 : z2, O5 = e6.symbolSpacing, B3 = void 0 === O5 ? 8 : O5, w3 = e6.theme, X2 = k3({ itemCount: i3.length, itemWidth: p3, itemHeight: y4, itemsSpacing: v4, direction: d3, padding: g3 }), H2 = X2.width, E3 = X2.height, j3 = X2.padding, T3 = x4({ anchor: s4, translateX: l3, translateY: c8, containerWidth: n3, containerHeight: o3, width: H2, height: E3 }), L = T3.x, M2 = T3.y, F2 = "row" === d3 ? p3 + v4 : 0, P3 = "column" === d3 ? y4 + v4 : 0;
  t7.save(), t7.translate(L, M2), t7.font = w3.legends.text.fontSize + "px " + (w3.legends.text.fontFamily || "sans-serif"), i3.forEach(function(e7, i4) {
    var n4, o4, r5 = i4 * F2 + j3.left, l4 = i4 * P3 + j3.top, a5 = S2({ direction: A3, justify: f4, symbolSize: C4, symbolSpacing: B3, width: p3, height: y4 }), c9 = a5.symbolX, s5 = a5.symbolY, d4 = a5.labelX, h4 = a5.labelY, g4 = a5.labelAnchor, m5 = a5.labelAlignment;
...
var j2 = function(t7) {
  var e6 = t7.scale, i3 = t7.domain, n3 = t7.reverse, o3 = void 0 !== n3 && n3, r4 = t7.valueFormat, l3 = void 0 === r4 ? function(t8) {
    return t8;
  } : r4, a4 = t7.separator, c8 = void 0 === a4 ? " - " : a4;
  return (0, import_react8.useMemo)(function() {
    var t8 = (null != i3 ? i3 : e6.range()).map(function(t9, i4) {
      var n4 = e6.invertExtent(t9), o4 = n4[0], r5 = n4[1];
      return { id: t9, index: i4, extent: [o4, r5], label: "" + l3(o4) + c8 + l3(r5), value: e6(o4), color: t9 };
    });
    return o3 && t8.reverse(), t8;
  }, [i3, e6, o3, c8, l3]);
};
...
//# sourceMappingURL=chunk-VKOF3U7M.js.map
